...
export const skills = {
  ...
  tools: [
    "AWS", "Streamlit", "pandas", "NumPy", 
    "Plotly", "Dataiku", "Git", "Docker"
  ],
  pm: [
    "Agile", "Roadmaps", "User Research", 
    "Stakeholder Communications", "A/B Testing", 
    "Product Analytics"
  ],
  certs: ["Certified Associate in Project Management (CAPM)"]
} as const;
